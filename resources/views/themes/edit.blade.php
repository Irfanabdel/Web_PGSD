        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <form action="{{ route('themes.update', $theme->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $theme->title) }}" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
                ...
                <div class="mb-6">
                    <table id="dimension-table" class="w-full border border-gray-200 rounded-lg shadow-sm">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="p-4 text-sm font-medium text-gray-500">Dimensi Profil Pelajar Pancasila</th>
                        ...
                        <tbody id="dimension-tbody" class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="p-4">
                                    <select name="dimensions[]" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                    ...
                    <button type="button" onclick="addDimensionRow()" class="mt-4 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Tambah Dimensi</button>
                </div>

                <!-- Input Project 1 -->
                <div>
                    <label for="project1" class="block mb-2 text-sm font-medium text-gray-900">Projek 1</label>
                    <input type="text" name="project1" id="project1" value="{{ old('project1', $theme->project1) }}" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>

                <!-- Input Project 2 -->
                <div>
                    <label for="project2" class="block mb-2 text-sm font-medium text-gray-900">Projek 2</label>
                    <input type="text" name="project2" id="project2" value="{{ old('project2', $theme->project2) }}" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" required>
                </div>
