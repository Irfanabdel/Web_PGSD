        ...
        <div class="bg-white shadow-md rounded-lg p-6 mb-6">
            ...
            <form action="{{ route('learnings.update.step2', ['learning' => $learning->id, 'module' => $module->id]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Perbaharui</button>
                </div>
            </form>
        </div>
    </div>
