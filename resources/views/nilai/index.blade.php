                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td rowspan="{{ $item->mapels->count() }}" class="p-4 space-x-2 whitespace-nowrap text-center">
                            ...
                            <form action="{{ route('nilai.destroy', $item->id) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 dark:bg-red-700 dark:hover:bg-red-800 dark:focus:ring-red-800 transition-colors">
