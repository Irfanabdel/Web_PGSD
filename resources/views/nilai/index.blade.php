            ...
            <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700">
                <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                        ...
                        <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Mata Pelajaran</th>
                        <th scope="col" class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">Nilai</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td class="p-4 text-sm font-normal text-gray-800 whitespace-nowrap">{{ $mapel->name }}</td>
                        <td class="p-4 text-sm font-normal text-gray-800 whitespace-nowrap">{{ $mapel->nilai }}</td>
                        @if($loop->first)
                        <td rowspan="{{ $item->mapels->count() }}" class="p-4 space-x-2 whitespace-nowrap">
                            <!-- Ubah Icon -->
