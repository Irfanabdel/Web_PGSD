<x-app-layout title="welcome">
  <div class="p-4 sm:ml-64">
    ...
    <img class="h-auto custom-size rounded-lg mx-auto" src="{{ asset('lebar.png') }}" alt="image description">

    <h2 class="mb-4 text-3xl font-extrabold tracking-tight leading-none text-black md:text-4xl lg:text-5xl text-center">
    ...
    <div class="box-container">
      <div class="box" style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <img src="{{ asset('modul_p5.png') }}" alt="Deskripsi Gambar 1" style="width: 300px; height: auto; display: block; margin: 0 auto;" class="rounded-lg">
  ...
  <img src="{{ asset('modul_p5_2.png') }}" alt="Deskripsi Gambar 2" style="width: 100%; height: auto; display: block; margin: 0 auto;" class="rounded-lg">
